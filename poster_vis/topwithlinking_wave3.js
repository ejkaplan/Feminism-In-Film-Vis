function buildTopRanked3() {
  ...
  d3.csv("../data/CombinedMoviesWave3b.csv", dataPreprocessor).then(function(moviedata) {
    allData = moviedata;
  });
  d3.csv("../data/CombinedMoviesWave3a.csv", dataPreprocessor).then(function(moviedata) {
  ...
  buildTopRanked3.updateData = updateData;
