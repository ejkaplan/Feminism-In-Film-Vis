function buildTopRanked2() {
  ...
  d3.csv("../data/CombinedMoviesWave2b.csv", dataPreprocessor).then(function(moviedata) {
    allData = moviedata;
  });
  d3.csv("../data/CombinedMoviesWave2a.csv", dataPreprocessor).then(function(moviedata) {
  ...
  buildTopRanked2.updateData = updateData;
