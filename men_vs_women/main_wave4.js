...
//Male axis
   ...
   var female20points = [
      ...
      [femaleGraphX + wScale(20), 300]
    ];

    var female40points = [
      [femaleGraphX + wScale(40), topPadding],
      [femaleGraphX + wScale(40), 300]
    ];

    var female60points = [
      [femaleGraphX + wScale(60), topPadding],
      [femaleGraphX + wScale(60), 300]
    ];

    var female80points = [
      [femaleGraphX + wScale(80), topPadding],
      [femaleGraphX + wScale(80), 300]
    ];
