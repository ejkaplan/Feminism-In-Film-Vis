function buildMenVsWomen1() {
  ...
  d3.csv('../data/movies.csv').then(function(dataset) {
    ...
    var male20points = [
      [malewScale(20)+15, topPadding],
      [malewScale(20)+15, 700]
    ];

    var male40points = [
      [malewScale(40)+15, topPadding],
      [malewScale(40)+15, 700]
    ];

    var male60points = [
      [malewScale(60)+15, topPadding],
      [malewScale(60)+15, 700]
    ];

    var male80points = [
      [malewScale(80)+15, topPadding],
      [malewScale(80)+15, 700]
    ];
...
//Male axis
   ...
   var female20points = [
      ...
      [femaleGraphX + wScale(20), 700]
    ];

    var female40points = [
      [femaleGraphX + wScale(40), topPadding],
      [femaleGraphX + wScale(40), 700]
    ];

    var female60points = [
      [femaleGraphX + wScale(60), topPadding],
      [femaleGraphX + wScale(60), 700]
    ];

    var female80points = [
      [femaleGraphX + wScale(80), topPadding],
      [femaleGraphX + wScale(80), 700]
    ];
